...
class RPN(nn.Module):
    ...
    def forward(self, x, bev=None):
        ...
        return ret_dict
    # def init_weight(self, ):   canshu chushihua
...
class VoxelNet(nn.Module):
    ...
    # def weight_init(self,vfe_num_filters.weights):
    #     random.seed()
    #     self.vfe_num_filters.apply(weight_init) = random.randint(0,1)
    #     self.middle_feature_extractor.apply(weight_init) = random.randint(0,1)
    #     self.rpn.apply(weight_init) = random.randint(0,1)
