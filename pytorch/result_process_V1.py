...
result_pkl0 = open(r"/home/yml/second.pytorch/second/result_evaluate/model0/eval_results/step_20699/result.pkl",'rb')
result_pkl1 = open(r"/home/yml/second.pytorch/second/result_evaluate/model1/eval_results/step_296960/result.pkl",'rb')
result_pkl2 = open(r"/home/yml/second.pytorch/second/result_evaluate/model2/eval_results/step_296962/result.pkl",'rb')
result_pkl3 = open(r"/home/yml/second.pytorch/second/result_evaluate/model3/eval_results/step_408320/result.pkl",'rb')
result_pkl4 = open(r"/home/yml/second.pytorch/second/result_evaluate/model4/eval_results/step_334080/result.pkl",'rb')
result_pkl5 = open(r"/home/yml/second.pytorch/second/result_evaluate/model5/eval_results/step_296960/result.pkl",'rb')
result_pkl6 = open(r"/home/yml/second.pytorch/second/result_evaluate/model6/eval_results/step_296960/result.pkl",'rb')
result_pkl7 = open(r"/home/yml/second.pytorch/second/result_evaluate/model7/eval_results/step_296960/result.pkl",'rb')
...
result5 = pickle.load(result_pkl5)
result6 = pickle.load(result_pkl6)
result7 = pickle.load(result_pkl7)


results = [result0,result1,result2,result3,result4,result5,result6,result7]
...
# Bboxes = [bbox[0][3],bbox[1][3],bbox[2][3],bbox[3][3],bbox[4][3],bbox[5][3],bbox[6][3],bbox[7][3]]   #  第i和网络的第j帧   8  nets
# Bboxes = [bbox[1][3],bbox[2][3],bbox[3][3],bbox[4][3],bbox[5][3],bbox[6][3],bbox[7][3]]   #  第i和网络的第j帧   7  nets
# Bboxes = [bbox[1][3],bbox[2][3],bbox[3][3],bbox[4][3],bbox[6][3],bbox[7][3]]   #  第i和网络的第j帧   6  nets
# Bboxes = [bbox[1][3],bbox[3][3],bbox[4][3],bbox[5][3],bbox[7][3]]   #  第i和网络的第j帧   5  nets
# Bboxes = [bbox[1][3],bbox[3][3],bbox[4][3],bbox[7][3]]   #  第i和网络的第j帧   4  nets
# Bboxes = [bbox[1][3],bbox[3][3],bbox[7][3]]   #  第i和网络的第j帧   3  nets
Bboxes = [bbox[1][3],bbox[3][3]]   #  第i和网络的第j帧   2  nets
# Bboxes = [bbox[1][3]]   #  第i和网络的第j帧   1  nets
...
# bbox_iou(b1, b2)
def bbox_in_cluster(cluster, bbox_tp, iou_thre=0.5):  # cluster已经分类的，bbox_tp未分类的
...
def BSAS_excl(Bboxes, iou_thre=0.5):
...
if len(Bboxes):
    clusters = BSAS_excl(Bboxes, iou_thre=0.5)
    for cluster in clusters:
